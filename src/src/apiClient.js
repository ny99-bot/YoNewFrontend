...
// Temporary "fake user id" until you hook up real Firebase auth on the client
...
/* ---------- AI endpoints (Gemini-like logic now living in YOUR backend) ---------- */
...
/* ---------- Trip data in Firestore (via YOUR backend) ---------- */
